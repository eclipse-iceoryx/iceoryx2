...
## Customizable platform abstraction

iceoryx2-pal offers a set of compile-time settings to
modify attributes like the path to the user configuration.
Additionally a custom POSIX abstraction can be integrated for
extended platform support.
See chapter [`Customize the platform abstraction`](https://ekxide.github.io/iceoryx2-book/main/how-to/customize-the-platform-abstraction.html)
in the iceoryx2-book for instructions.
