...
pub mod arc_sync_policy_leakable_trait {
    ...
    #[conformance_test]
    pub fn create_and_locked_access_to_value_works<Sut: ArcSyncPolicy<AbandonTacker>>() {
        let tracker = AbandonTacker::start_tracking();
        let sut = Sut::new(AbandonTacker::new()).unwrap();
