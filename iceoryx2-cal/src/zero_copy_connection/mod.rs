...
pub trait ZeroCopySender: Debug + ZeroCopyPortDetails + NamedConcept + Send + Leakable {
    fn try_send(
        &self,
        ptr: PointerOffset,
        sample_size: usize,
...
pub trait ZeroCopyReceiver: Debug + ZeroCopyPortDetails + NamedConcept + Send + Leakable {
