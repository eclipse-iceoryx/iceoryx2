...
| ------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| blackboard                                 | [Rust](rust/blackboard)                                                                                                                                                                         | Unidirectional communication where one writer updates data in a inter-process key-value store, called the blackboard, which several readers can read.                                                           |
| blackboard_event_based_communication       | [Rust](rust/blackboard_event_based_communication)                                                                                                                                               | Updating a inter-process key-value store, called the blackboard, where a writer sends notifications whenever a value is updated.                                                                                |
