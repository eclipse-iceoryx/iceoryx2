...
| publish subscribe with unable to deliver handler | [Rust](rust/publish_subscribe_with_unable_to_deliver_handler)                                                                                                                             | Communication between multiple processes with a [publish subscribe messaging pattern](https://en.wikipedia.org/wiki/Publish–subscribe_pattern) and custom unable to deliver handling.                           |
