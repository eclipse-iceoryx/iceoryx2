...
| flatbuffer request response                  | [Rust](rust/flatbuffer_request_response)                                                                                                                                                        | Native flatbuffer integration and sending fully dynamic unbounded data types between a client and a server.                                                                                                     |
