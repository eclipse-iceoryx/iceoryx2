...
| publish subscribe with unable to deliver   | [C](c/publish_subscribe_unable_to_deliver) [C++](cxx/publish_subscribe_unable_to_deliver) [Rust](rust/publish_subscribe_unable_to_deliver)                                                      | Communication between multiple processes with a [publish subscribe messaging pattern](https://en.wikipedia.org/wiki/Publish–subscribe_pattern) and custom unable to deliver handling.                           |
