...
| service variants                     | [Rust](rust/service_variants)                                                                                                                                                               | Introduction in service variations, like `local::Service` optimized for intra-process communication or `ipc_threadsafe::Service` where all ports are threadsafe                                                 |
