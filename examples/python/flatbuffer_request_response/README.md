...
```sh
flatc -o examples/python/flatbuffer_request_response --python \
    examples/python/flatbuffer_request_response/unbounded_data.fbs
flatc -o examples/python/flatbuffer_request_response --python \
    examples/python/flatbuffer_request_response/data_props.fbs
```
...
```sh
flatc -o examples/python/flatbuffer_request_response --schema --binary \
    examples/python/flatbuffer_request_response/unbounded_data.fbs
flatc -o examples/python/flatbuffer_request_response --schema --binary \
    examples/python/flatbuffer_request_response/data_props.fbs
```
...
poetry --project iceoryx2-ffi/python run python examples/python/flatbuffer_request_response/client.py
```
...
```sh
export IOX2_FLATBUFFER_SCHEMA_PATH="$(pwd)/examples/python/flatbuffer_request_response"
poetry --project iceoryx2-ffi/python run python examples/python/flatbuffer_request_response/server.py
```
