...
```sh
python examples/python/domains/subscriber.py fuu bar
```

### Terminal 2: Publisher in domain "fuu" publishing on service "bar"

```sh
python examples/python/domains/publisher.py fuu bar
```

### Terminal 3: List all services of domain "fuu"

```sh
python examples/python/domains/discovery.py fuu
```
