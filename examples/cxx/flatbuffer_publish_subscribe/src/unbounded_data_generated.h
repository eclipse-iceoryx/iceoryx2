...
struct Entry FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::VerifierTemplate<B> &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_DATA_1, 4) &&
           VerifyField<uint64_t>(verifier, VT_DATA_2, 8) &&
           verifier.EndTable();
  }
};
...
inline ::flatbuffers::Offset<UnboundedData> CreateUnboundedData(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline ::flatbuffers::Offset<UnboundedData> CreateUnboundedDataDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return Example::CreateUnboundedData(
      _fbb,
      title__,
      entries__);
}
