...
```sh
./target/ffi/c/build/examples/publish_subscribe_with_user_header/example_c_with_user_header_subscriber
```

### Terminal 2

```sh
./target/ffi/c/build/examples/publish_subscribe_with_user_header/example_c_with_user_header_publisher
```
