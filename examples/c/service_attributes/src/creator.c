...
int main(void) {
    ...
    ret_val = iox2_attribute_specifier_new(NULL, &attribute_specifier);
    if (ret_val != IOX2_OK) {
        printf("Unable to create service attribute specifier! Error: %d\n", ret_val);
        goto drop_service_name;
    }
    ...
    ret_val = iox2_service_builder_pub_sub_create_with_attributes(
