...
```sh
./target/ff/cc/build/examples/c/publish_subscribe_with_unable_to_deliver_handler/example_c_publish_subscribe_with_unable_to_deliver_handler_subscriber
```

### Terminal 2

```sh
./target/ff/cc/build/examples/c/publish_subscribe_with_unable_to_deliver_handler/example_c_publish_subscribe_with_unable_to_deliver_handler_publisher
```
