...
```sh
./target/ffi/c/build/examples/request_response/example_c_request_response_client
```

### Terminal 2

```sh
./target/ffi/c/build/examples/request_response/example_c_request_response_server
```
