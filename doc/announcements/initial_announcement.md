...
Moreover, Rust allows for the incorporation of contracts directly into code
...
In my view, the answer to all three questions tends to be "no." Unless addressed
