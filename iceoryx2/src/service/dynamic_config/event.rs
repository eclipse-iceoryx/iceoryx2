...
impl DynamicConfig {
    ...
    /// Returns how many [`crate::port::listener::Listener`] ports are currently connected.
    pub fn number_of_listeners(&self) -> usize {
        self.listeners.len()
    }

    /// Returns how many [`crate::port::notifier::Notifier`] ports are currently connected.
