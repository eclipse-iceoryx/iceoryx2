...
/// Relay for bridging iceoryx2 publish-subscribe samples through a backend.
///
...
///
/// ```no_run
/// # use iceoryx2_gateway_backend::traits::PublishSubscribeRelay;
/// # use iceoryx2_gateway_backend::types::publish_subscribe::Sample;
