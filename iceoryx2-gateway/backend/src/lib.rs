...
//! Backend traits and types for bridging `iceoryx2` services across hosts.
//!
//! This crate provides the trait abstractions necessary to implement custom
//! communication backends that bridge `iceoryx2` [`Service`](iceoryx2::service::Service)s
...
//! consistent interface for the `iceoryx2` gateway infrastructure.
//!
//! # Overview
//!
...
//! - [`PublishSubscribeRelay`](traits::PublishSubscribeRelay): Bidirectional pub-sub data bridging
//! - [`EventRelay`](traits::EventRelay): Bidirectional event notification bridging
...
//! # Architecture
//!
//! A gateway backend implementation consists of two main components:
//!
...
//! # Usage
//!
//! This crate is intended for developers implementing custom gateway backends.
