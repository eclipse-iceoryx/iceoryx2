...
struct OptionWithDetailsFactory {
    ...
    static Type_t createEmpty() {
        return Type_t { {}, "", iox2::legacy::cli::OptionType::Switch, "" };
    }
};
...
TYPED_TEST(OptionTest, optionWithLongOptionIsNotEmpty) {
    ...
    sut.longOption =
        iox2::legacy::cli::OptionName_t(iox2::legacy::TruncateToCapacity, "TheLeafSheepWantsToBeYourFriend");
...
TYPED_TEST(OptionTest, optionWithShortAndLongOptionIsNotEmpty) {
    ...
    auto sut = this->createEmpty();
    sut.shortOption = 'b';
    sut.longOption = iox2::legacy::cli::OptionName_t(iox2::legacy::TruncateToCapacity, "PleaseDoNotPetTheHypnotoad");
    EXPECT_FALSE(sut.isEmpty());
}
...
TYPED_TEST(OptionTest, longOptionWithoutDashDoesNotStartWithDash) {
    ...
    auto sut = this->createEmpty();
    sut.longOption =
        iox2::legacy::cli::OptionName_t(iox2::legacy::TruncateToCapacity, "WhyDoesDonaldDuckNeverWearsPants?");
    EXPECT_FALSE(sut.longOptionNameDoesStartWithDash());
}
...
TYPED_TEST(OptionTest, longOptionWithLeadingDashIsDetected) {
    ...
    auto sut = this->createEmpty();
    sut.longOption = iox2::legacy::cli::OptionName_t(iox2::legacy::TruncateToCapacity, "-dashOhNo");
...
TYPED_TEST(OptionTest, hasSameLongOptionNameFailsWhenBothAreDifferent) {
    ...
    auto sut = this->createEmpty();
    sut.longOption = iox2::legacy::cli::OptionName_t(iox2::legacy::TruncateToCapacity, "ChemistryIsTheArt...");
...
TYPED_TEST(OptionTest, hasSameLongOptionNameWorksWhenBothAreEqual) {
    ...
    auto sut = this->createEmpty();
    sut.longOption =
        iox2::legacy::cli::OptionName_t(iox2::legacy::TruncateToCapacity, "IWouldBeMoreProductiveOnHawaii");
...
TYPED_TEST(OptionTest, hasSameShortOptionNameFailsWhenBothAreEmpty) {
    ...
    auto sut = this->createEmpty();
    EXPECT_FALSE(sut.hasShortOptionName(iox2::legacy::cli::NO_SHORT_OPTION));
}
...
TYPED_TEST(OptionTest, hasOptionNameWorksWhenEqualToLongOption) {
    ...
    auto sut = this->createEmpty();
    sut.longOption =
        iox2::legacy::cli::OptionName_t(iox2::legacy::TruncateToCapacity, "AskYourselfWhatWouldHypnotoadDo");
...
TYPED_TEST(OptionTest, sameShortAndLongOptionsWithDifferentValueAreTheSameOption) {
    ...
    auto sut = this->createEmpty();
    sut.shortOption = 'k';
    sut.longOption = iox2::legacy::cli::OptionName_t(iox2::legacy::TruncateToCapacity, "IHateMeetings");
    sut.value = "bla";
...
TYPED_TEST(OptionTest, sameShortOptionDifferentLongOptionAreNotTheSameOption) {
    ...
    auto sut = this->createEmpty();
    sut.shortOption = 'k';
    sut.longOption = iox2::legacy::cli::OptionName_t(iox2::legacy::TruncateToCapacity, "BlueberrysAreNice");
    sut.value = "bla";

    auto sut2 = this->createEmpty();
    sut2.shortOption = sut.shortOption;
    sut.longOption =
        iox2::legacy::cli::OptionName_t(iox2::legacy::TruncateToCapacity, "ButWhatAboutTheSwedishWhitebeam");
...
TYPED_TEST(OptionTest, sameLongOptionDifferentShortOptionAreNotTheSameOption) {
    ...
    auto sut = this->createEmpty();
    sut.shortOption = 'k';
    sut.longOption = iox2::legacy::cli::OptionName_t(iox2::legacy::TruncateToCapacity, "ArnoldSchwarzeneggerIsMozart");
    sut.value = "bla";
...
TYPED_TEST(OptionTest, setupLongOptionHasLongOption) {
    ...
    auto sut = this->createEmpty();
    sut.longOption = iox2::legacy::cli::OptionName_t(iox2::legacy::TruncateToCapacity, "MozartHadASon");
