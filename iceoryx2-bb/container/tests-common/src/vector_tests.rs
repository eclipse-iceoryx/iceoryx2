...
pub struct RelocatableVecFactory {
    raw_memory:
        UnsafeCell<Box<[u8; RelocatableVec::<LifetimeTracker>::const_memory_size(SUT_CAPACITY)]>>,
}
...
#[inventory_test(PolymorphicVecFactory, RelocatableVecFactory, StaticVecFactory)]
