...
#[inventory_test_generic(File, SharedMemory)]
fn file_descriptor_permission_handling_works<Sut: GenericTestBuilder + FileDescriptorManagement>() {
    file_descriptor_tests::file_descriptor_permission_handling_works::<Sut>();
}

#[inventory_test_generic(File, SharedMemory)]
fn file_descriptor_metadata_handling_works<Sut: GenericTestBuilder + FileDescriptorManagement>() {
