...
While developing, iceoryx2 gets its default logging level from `.cargo/config.toml`, 
but this can be over-ridden by using environment variable `IOX2_LOG_LEVEL` that can
be set with one of the supported levels.
