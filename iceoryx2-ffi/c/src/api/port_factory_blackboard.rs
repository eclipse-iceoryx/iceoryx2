...
///
#[unsafe(no_mangle)]
pub unsafe extern "C" fn iox2_port_factory_blackboard_try_cleanup_dead_nodes(
...
///
#[unsafe(no_mangle)]
pub unsafe extern "C" fn iox2_port_factory_blackboard_blocking_cleanup_dead_nodes(
    port_factory_handle: iox2_port_factory_blackboard_h_ref,
    cleanup_state: *mut iox2_cleanup_state_t,
    timeout_secs: u64,
    timeout_nsecs: u32,
