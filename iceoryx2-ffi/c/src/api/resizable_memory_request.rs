...
use core::ffi::c_int;
use iceoryx2::request_mut_uninit::FlatbufferMemory;
...
#[repr(C)]
#[iceoryx2_ffi(ResizableMemoryRequestUnion)]
pub struct iox2_resizable_memory_request_t {
    service_type: iox2_service_type_e,
    value: iox2_resizable_memory_request_storage_t,
    deleter: fn(*mut iox2_resizable_memory_request_t),
}

impl iox2_resizable_memory_request_t {
    pub(super) fn init(
        &mut self,
        service_type: iox2_service_type_e,
        value: ResizableMemoryRequestUnion,
        deleter: fn(*mut iox2_resizable_memory_request_t),
    ) {
...
impl AssertNonNullHandle for iox2_resizable_memory_request_h_ref {
    fn assert_non_null(self) {
        debug_assert!(!self.is_null());
        unsafe {
            debug_assert!(!(*self).is_null());
...
impl HandleToType for iox2_resizable_memory_request_h {
    type Target = *mut iox2_resizable_memory_request_t;
...
impl HandleToType for iox2_resizable_memory_request_h_ref {
    type Target = *mut iox2_resizable_memory_request_t;
...
///
#[unsafe(no_mangle)]
pub unsafe extern "C" fn iox2_resizable_memory_request_grow_downwards(
    handle: iox2_resizable_memory_request_h_ref,
    new_size: usize,
    in_use_front: usize,
    new_ptr: *mut *mut u8,
) -> c_int {
...
///
#[unsafe(no_mangle)]
pub unsafe extern "C" fn iox2_resizable_memory_request_ptr(
    handle: iox2_resizable_memory_request_h_ref,
) -> *mut u8 {
    handle.assert_non_null();
    unsafe {
...
///
#[unsafe(no_mangle)]
pub unsafe extern "C" fn iox2_resizable_memory_request_len(
    handle: iox2_resizable_memory_request_h_ref,
) -> usize {
    handle.assert_non_null();
    unsafe {
...
///
#[unsafe(no_mangle)]
pub unsafe extern "C" fn iox2_resizable_memory_request_drop(
    handle: iox2_resizable_memory_request_h,
) {
