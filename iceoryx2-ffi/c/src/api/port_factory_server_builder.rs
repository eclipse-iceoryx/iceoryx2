...
use super::{
    IntoCInt, PayloadFfi, UserHeaderFfi, c_size_t, degradation_context_cast,
    iox2_allocation_strategy_e, iox2_callback_context, iox2_degradation_callback, iox2_server_h,
...
pub struct iox2_port_factory_server_builder_storage_t {
    internal: [u8; 224], // magic number obtained with size_of::<Option<PortFactoryServerBuilderUnion>>()
}
...
/// Sets the request degradation callback for the sever
///
/// # Arguments
///
/// * `port_factory_handle` - Must be a valid [`iox2_port_factory_server_builder_h_ref`]
...
/// * `port_factory_handle` must be valid handles
#[unsafe(no_mangle)]
pub unsafe extern "C" fn iox2_port_factory_server_builder_set_request_degradation_callback(
    port_factory_handle: iox2_port_factory_server_builder_h_ref,
    ...
    unsafe {
        ...
        match port_factory_struct.service_type {
            iox2_service_type_e::IPC => {
                ...
                port_factory_struct.set(PortFactoryServerBuilderUnion::new_ipc(
                    port_factory.set_request_degradation_callback(move |cause, context| {
                        callback(
                            cause.into(),
...
/// Sets the response degradation callback for the server
///
/// # Arguments
///
/// * `port_factory_handle` - Must be a valid [`iox2_port_factory_server_builder_h_ref`]
...
/// * `port_factory_handle` must be valid handles
#[unsafe(no_mangle)]
pub unsafe extern "C" fn iox2_port_factory_server_builder_set_response_degradation_callback(
    port_factory_handle: iox2_port_factory_server_builder_h_ref,
    callback: iox2_degradation_callback,
    callback_ctx: iox2_callback_context,
) {
    ...
    unsafe {
        ...
        match port_factory_struct.service_type {
            iox2_service_type_e::IPC => {
                ...
                port_factory_struct.set(PortFactoryServerBuilderUnion::new_ipc(
                    port_factory.set_response_degradation_callback(move |cause, context| {
                        callback(
                            cause.into(),
                            degradation_context_cast(context),
                            callback_ctx,
