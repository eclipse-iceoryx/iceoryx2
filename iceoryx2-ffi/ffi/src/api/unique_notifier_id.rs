...
pub struct iox2_unique_notifier_id_t {
    value: [u8; 16], // core::mem::size_of::<UniqueNotifierId>()
}

impl iox2_unique_notifier_id_t {
    pub(super) fn as_ref(&self) -> &UniqueNotifierId {
        static_assert_ge::<
            { core::mem::align_of::<Self>() },
            { core::mem::align_of::<UniqueNotifierId>() },
        >();
        static_assert_ge::<
            { core::mem::size_of::<Self>() },
            { core::mem::size_of::<UniqueNotifierId>() },
        >();

        unsafe { core::mem::transmute(self.value.as_ptr()) }
    }

    pub(super) fn as_mut(&mut self) -> &mut UniqueNotifierId {
        unsafe { core::mem::transmute(self.value.as_ptr()) }
    }
}
