...
use crate::{
    ...
    iox2_subscriber_receive_error_e, iox2_type_detail_error_e, iox2_wait_event_e,
};
...
#[no_mangle]
// TODO: enums are only exported when they are actually used by some function
pub unsafe extern "C" fn __iox2_internal_wait_event_stub() -> iox2_wait_event_e {
    iox2_wait_event_e::TICK
}
