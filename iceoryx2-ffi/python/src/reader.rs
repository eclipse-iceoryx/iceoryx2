...
impl Reader {
    ...
    pub fn __entry(&self, key: usize, value_type_details: TypeDetail) -> PyResult<EntryHandle> {
        match &*self.value.lock() {
            ReaderType::Ipc(Some(v)) => {
                ...
                Ok(EntryHandle {
                    value: Parc::new(EntryHandleType::Ipc(entry_handle)),
                    value_type_details: value_type_details.clone(),
                    value_type_storage: TypeStorage::new(),
                    value_ptr: Parc::new(InternalValueStorage {
            ...
            ReaderType::Local(Some(v)) => {
                ...
                Ok(EntryHandle {
                    value: Parc::new(EntryHandleType::Local(entry_handle)),
                    value_type_details: value_type_details.clone(),
                    value_type_storage: TypeStorage::new(),
                    value_ptr: Parc::new(InternalValueStorage {
                        value_buffer: core::ptr::null_mut::<u8>(),
