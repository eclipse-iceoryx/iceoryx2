# iceoryx2-integrations-ros2-gateway-backend
...
Gateway backend connecting native iceoryx2 applications with ROS 2 nodes,
implemented on the
...
The gateway is run via the CLI in [`../gateway-cli`](../gateway-cli):
