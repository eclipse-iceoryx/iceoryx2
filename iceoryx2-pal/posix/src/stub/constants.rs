...
pub const PF_UNIX: sa_family_t = 1;
pub const SO_PASSCRED: int = 1;
pub const SO_PEERCRED: int = 2;
pub const SO_SNDBUF: int = 7;
pub const SO_RCVBUF: int = 8;
pub const SO_RCVTIMEO: int = 20;
pub const SO_SNDTIMEO: int = 21;
