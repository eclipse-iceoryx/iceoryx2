...
pub type ulong = libc::u_long;
pub type kinfo_file = libc::kinfo_file;
...
// impl MemZeroedStruct for pthread_rwlockattr_t {} // implemented via 'MemZeroedStruct for pthread_attr_t' which is a *mut c_void

pub type pthread_rwlock_t = libc::pthread_rwlock_t;
// impl MemZeroedStruct for pthread_rwlock_t {} // implemented via 'MemZeroedStruct for pthread_attr_t' which is a *mut c_void

pub type pthread_mutex_t = libc::pthread_mutex_t;
// impl MemZeroedStruct for pthread_mutex_t {} // implemented via 'MemZeroedStruct for pthread_attr_t' which is a *mut c_void

pub type pthread_mutexattr_t = libc::pthread_mutexattr_t;
// impl MemZeroedStruct for pthread_mutexattr_t {} // implemented via 'MemZeroedStruct for pthread_attr_t' which is a *mut c_void
