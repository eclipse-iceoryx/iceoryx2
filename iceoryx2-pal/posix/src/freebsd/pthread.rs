...
pub unsafe fn pthread_attr_setschedparam(
    ...
    unsafe { crate::internal::pthread_attr_setschedparam(attr, param) }
}

pub unsafe fn pthread_attr_setstacksize(attr: *mut pthread_attr_t, stacksize: size_t) -> int {
    unsafe { crate::internal::pthread_attr_setstacksize(attr, stacksize) }
}
...
pub unsafe fn pthread_create(
    ...
    unsafe { crate::internal::pthread_create(thread, attr, Some(start_routine), arg) }
}
