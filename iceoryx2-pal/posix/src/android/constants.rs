...
pub const PTHREAD_MUTEX_STALLED: int = -1; //libc::PTHREAD_MUTEX_STALLED as _;
pub const PTHREAD_MUTEX_ROBUST: int = -2; //libc::PTHREAD_MUTEX_ROBUST as _;
...
pub const _SC_XOPEN_XPG2: int = -1; //libc::_SC_XOPEN_XPG2 as _;
pub const _SC_XOPEN_XPG3: int = -1; //libc::_SC_XOPEN_XPG3 as _;
pub const _SC_XOPEN_XPG4: int = -1; //libc::_SC_XOPEN_XPG4 as _;
pub const _SC_NZERO: int = -1; //libc::_SC_NZERO as _;
...
pub const _SC_STREAMS: int = -1; //libc::_SC_STREAMS as _;
...
pub const _PC_SOCK_MAXBUF: int = -1; //libc::_PC_SOCK_MAXBUF as _;
...
pub const PTHREAD_PROCESS_PRIVATE: int = 0; // from toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/pthread.h
pub const PTHREAD_PROCESS_SHARED: int = 1; // from toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/pthread.h
pub const PTHREAD_PRIO_NONE: int = 0; // from toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/pthread.h
pub const PTHREAD_PRIO_INHERIT: int = 1; // from toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/pthread.h
pub const PTHREAD_PRIO_PROTECT: int = -1;
...
pub const RLIMIT_RTTIME: __rlim_t = 15; // from toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/asm-generic/resource.h
pub const RLIMIT_NLIMITS: __rlim_t = 16; // from toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/asm-generic/resource.h
pub const RLIMIT_INFINITY: __rlim_t = __rlim_t::MAX;

pub const SCHED_OTHER: int = libc::SCHED_NORMAL as _; // toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/sched.h
...
pub const _SC_V6_ILP32_OFF32: int = -1;
pub const _SC_V6_ILP32_OFFBIG: int = -1;
pub const _SC_V6_LP64_OFF64: int = -1;
pub const _SC_V6_LPBIG_OFFBIG: int = -1;
...
pub const _PC_FILESIZEBITS: int = 0; // from from toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/unistd.h
