        ...
        CliSection {
            ...
            entries: vec![
                CliEntry {
                    ...
                    value_type: "string",
                    default: format!("\"{}\"", config.global.root_path()),
                    description: "Defines the path for all iceoryx2 files and directories.",
                },
                CliEntry {
                    key: "global.prefix",
                    value_type: "string",
                    default: format!("\"{}\"", config.global.prefix),
