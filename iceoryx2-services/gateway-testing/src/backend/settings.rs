...
pub const ROOT_DIR: &[u8] = b"/tmp/iceoryx2/gateways/test-backend";
#[cfg(target_os = "nto")]
pub const ROOT_DIR: &[u8] = b"/data/iceoryx2/gateways/test-backend";
#[cfg(target_os = "windows")]
pub const ROOT_DIR: &[u8] = b"C:\\Temp\\iceoryx2\\gateways\\test-backend";
