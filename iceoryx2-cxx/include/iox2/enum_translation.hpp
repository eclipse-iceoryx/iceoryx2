...
constexpr auto from<iox2_degradation_cause_e, iox2::DegradationCause>(const iox2_degradation_cause_e value) noexcept
    ...
    case iox2_degradation_cause_e_UNABLE_TO_DELIVER_DATA:
        return iox2::DegradationCause::UnableToDeliverData;
    case iox2_degradation_cause_e_INVALID_DEGRADATION_ACTION:
        return iox2::DegradationCause::InvalidDegradationAction;
    }
...
constexpr auto from<iox2::DegradationAction, iox2_degradation_action_e>(const iox2::DegradationAction value) noexcept
    ...
    switch (value) {
    case iox2::DegradationAction::Default:
        return iox2_degradation_action_e_DEFAULT;
    case iox2::DegradationAction::Ignore:
        return iox2_degradation_action_e_IGNORE;
    case iox2::DegradationAction::Discard:
        return iox2_degradation_action_e_DISCARD;
    case iox2::DegradationAction::Retry:
        return iox2_degradation_action_e_RETRY;
    case iox2::DegradationAction::Block:
        return iox2_degradation_action_e_BLOCK;
    case iox2::DegradationAction::Warn:
        return iox2_degradation_action_e_WARN;
    case iox2::DegradationAction::Fail:
        return iox2_degradation_action_e_FAIL;
    }
