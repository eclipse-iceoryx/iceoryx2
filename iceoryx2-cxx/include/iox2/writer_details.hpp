...
#ifndef IOX2_WRITER_DETAILS_HPP
#define IOX2_WRITER_DETAILS_HPP
...
class WriterDetailsView {
  public:
    ...
    auto operator=(const WriterDetailsView&) -> WriterDetailsView& = delete;
    auto operator=(WriterDetailsView&& rhs) noexcept -> WriterDetailsView&;
