...
auto list_ports_callback(void* context, const T port_details_view) -> iox2_callback_progression_e {
    auto* callback = internal::ctx_cast<iox2::bb::Function<CallbackProgression(ViewType)>>(context);
...
auto list_callback(iox2_node_state_e node_state,
    ...
    auto* callback = internal::ctx_cast<iox2::bb::Function<CallbackProgression(NodeState<T>)>>(context);
