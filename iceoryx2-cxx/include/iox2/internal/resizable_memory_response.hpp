...
#ifndef IOX2_RESIZABLE_MEMORY_RESPONSE_HPP
#define IOX2_RESIZABLE_MEMORY_RESPONSE_HPP
...
class ResizableMemoryResponse : public flatbuffers::Allocator {
  public:
    ResizableMemoryResponse(const ResizableMemoryResponse&) = delete;
    ResizableMemoryResponse(ResizableMemoryResponse&&) noexcept;
    ~ResizableMemoryResponse() override;

    auto operator=(const ResizableMemoryResponse&) noexcept -> ResizableMemoryResponse& = delete;
    auto operator=(ResizableMemoryResponse&&) noexcept -> ResizableMemoryResponse&;
  ...
  private:
    ...
    iox2_resizable_memory_response_h m_handle = nullptr;
...
#endif // IOX2_RESIZABLE_MEMORY_RESPONSE_HPP
