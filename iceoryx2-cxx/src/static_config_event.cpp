...
auto StaticConfigEvent::notifier_created_event() const -> iox2::container::Optional<EventId> {
...
auto StaticConfigEvent::notifier_dropped_event() const -> iox2::container::Optional<EventId> {
...
auto StaticConfigEvent::notifier_dead_event() const -> iox2::container::Optional<EventId> {
...
auto StaticConfigEvent::deadline() const -> iox2::container::Optional<iox2::bb::Duration> {
