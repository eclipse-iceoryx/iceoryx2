...
install(
    ...
    ARCHIVE DESTINATION ${DESTINATION_LIBDIR} COMPONENT dev
)
...
# shared lib artifact (.so) -> runtime package
install(
    FILES ${ICEORYX2_C_SHARED_LIB_LINK_FILE}
    DESTINATION ${DESTINATION_LIBDIR}
    COMPONENT lib
)

# static lib artifact (.a) -> development package
install(
    FILES ${ICEORYX2_C_STATIC_LIB_LINK_FILE}
    DESTINATION ${DESTINATION_LIBDIR}
    COMPONENT dev
)
